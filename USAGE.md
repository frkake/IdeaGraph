...
| 実験ID | 名前 | モード | 説明 |
|--------|------|--------|------|
| EXP-101 | 3手法比較 | Pairwise | IdeaGraph / Baseline / Chain-of-Ideas の3手法直接比較 |
| EXP-102 | vs 元論文 | Pairwise | IdeaGraph 生成アイデア vs ターゲット論文（品質校正） |
| EXP-103 | IdeaGraph 単体 | Single | IdeaGraph の絶対スコア計測 |
| EXP-104 | Baseline 単体 | Single | Baseline の絶対スコア計測 |
| EXP-105 | Chain-of-Ideas 単体 | Single | Chain-of-Ideas の絶対スコア計測 |
...
| EXP-202 | グラフ表現形式アブレーション | ablation | graph_format={mermaid,paths,json_graph,triples,narrative} で表現形式を比較 |
